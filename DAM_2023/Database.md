...
- $T_D$ is [a doubly logarithmic tree](https://en.wikipedia.org/wiki/Doubly_logarithmic_tree) with height 5 ($\vertV_{T_D}\vert = 119\,041$). The experiments used this graph with values of $s = \{4, 5\}$. See Table **2**, Rows **2** and **3**.
